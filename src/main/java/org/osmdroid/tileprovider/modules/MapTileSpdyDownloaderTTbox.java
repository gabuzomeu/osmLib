...
public class MapTileSpdyDownloaderTTbox extends MapTileModuleProviderBase {
	...
	private static final String TAG = "MapTileSpdyDownloaderTTbox";
	...
	public MapTileSpdyDownloaderTTbox(final ITileSource pTileSource) {
		this(pTileSource, null, null);
	}

	public MapTileSpdyDownloaderTTbox(final ITileSource pTileSource, final IFilesystemCache pFilesystemCache) {
		this(pTileSource, pFilesystemCache, null);
	}

	public MapTileSpdyDownloaderTTbox(final ITileSource pTileSource, final IFilesystemCache pFilesystemCache, final INetworkAvailablityCheck pNetworkAvailablityCheck) {
